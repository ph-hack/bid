...
background and foreground images collected from the WEB.
"""
...
print("Number of images for 70 backgrounds =", specs.n_combinations(70))

i = 1
generate_dataset('../background_temp/', '../foreground/', '../images/', specs=specs, log_file='../dataset_inventory_{}.csv'.format(i), log_init_rows=0, verbose=1)